...
public class OfferPane  extends JPanel implements PropertyChangeListener {
    ...
    private volatile JButton yourTokensButton;
    private volatile JButton partnerTokensButton;
    private volatile JButton unassignedTokensButton;
    private volatile JButton sendButton;
    private volatile JButton acceptButton;
    private volatile JButton rejectButton;
    private volatile TokenButton tokenButtonToMove;
    private volatile JLabel offerPanelLabel;
    private volatile JLabel receivedOfferMessageLabel;
    private volatile JPanel centerPanel;
    private volatile JPanel leftPanel;
    private volatile JPanel rightPanel;
    private volatile JPanel middlePanel;
    private volatile JPanel receivedOfferPanel;
    private volatile JPanel acceptRejectPanel;
    private volatile JPanel yourTokensPartnerTokens;
    ...
    private volatile boolean isSendButtonOnScreen = false;
